...
class Ui_MainWindow(object):
    ...
    def Alcohol_Concentration(self):
        ...
        print(round(self.finalConcentration, 2))


        if self.finalConcentration <= 0:
            print("You're sober and in control!")

        elif self.finalConcentration >= 0.01 and self.finalConcentration <= 0.02:

            print("You may feel relaxed with some mood changes.")

        elif self.finalConcentration > 0.02 and self.finalConcentration < 0.05:
        ...
        elif self.finalConcentration > 0.09 and self.finalConcentration < 0.2:
        ...
        elif self.finalConcentration >= 0.2 and self.finalConcentration < 0.3:
